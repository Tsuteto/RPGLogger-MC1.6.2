...
public class ParamHorse extends ParamEntityAnimal<EntityHorse>
{
    ...
    public ParamHorse(EntityHorse entity, EntityPlayer player, ParamWorld world)
    {
        ...
        this.isTamed = entity.func_110248_bS();
        this.owner = entity.func_142019_cb();
        ...
        this.hasChest = entity.func_110261_ca(); // ChestedHorse
        ...
        this.temperPts = entity.func_110252_cg(); // Temper
