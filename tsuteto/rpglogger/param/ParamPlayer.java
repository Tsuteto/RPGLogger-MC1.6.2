...
public class ParamPlayer extends ParamEntityLivingBase<EntityPlayer> implements IParamPlayer
{
    ...
    {
        return worldObj.clip(Vec3.createVectorHelper(this.posX, this.posY + this.eyeHeight, this.posZ), Vec3.createVectorHelper(par1Entity.posX, par1Entity.posY + par1Entity.getEyeHeight(), par1Entity.posZ)) == null;
    }
}
