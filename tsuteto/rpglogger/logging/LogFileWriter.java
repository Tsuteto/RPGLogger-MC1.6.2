...
public final class LogFileWriter
{
    ...
    public LogFileWriter(ParamWorld paramWorld)
    {
        String worldName = paramWorld.worldName;
        ...
        {
            RpgLogger.systemLog("Failed to open file: " + logFile.getAbsolutePath());
            e.printStackTrace();
        }
    }
    ...
    public void showLogFile()
    {
        ...
        {
            RpgLogger.systemLog("Failed to show log file. This operation is not supported by your system");
            return;
        }

        if (!logFile.exists())
        {
            RpgLogger.systemLog("Could not find log file: " + logFile.getAbsolutePath());
            return;
        }
        ...
        {
            RpgLogger.systemLog("Failed to show log file: " + logFile.getAbsolutePath());
        }
    }
